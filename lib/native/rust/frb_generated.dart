...
import 'api/audio_output_device.dart';
...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1955556121;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<AudioIdentity> crateApiLibraryDbAudioIdentityDefault();
  ...
  List<AudioOutputDeviceInfo>?
  crateApiAudioOutputDeviceListRenderAudioDevices();
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
  ...
  TaskConstMeta get kCrateApiNeNetEaseCloudDefaultConstMeta =>
      const TaskConstMeta(debugName: 'NetEaseCloud_default', argNames: []);
  ...
  TaskConstMeta get kCrateApiNeNetEaseCloudInitConstMeta =>
      const TaskConstMeta(debugName: 'NetEaseCloud_init', argNames: ['that']);
  ...
  TaskConstMeta get kCrateApiNeNetEaseCloudNewConstMeta =>
      const TaskConstMeta(debugName: 'NetEaseCloud_new', argNames: []);
  ...
  TaskConstMeta get kCrateApiAmllTtmlAmllClearCacheConstMeta =>
      const TaskConstMeta(debugName: 'amll_clear_cache', argNames: []);
  ...
  TaskConstMeta get kCrateApiAmllTtmlAmllGetTtmlConstMeta =>
      const TaskConstMeta(debugName: 'amll_get_ttml', argNames: ['id']);
  ...
  Future<AudioIdentity> crateApiLibraryDbAudioIdentityDefault() {
    return handler.executeNormal(
      NormalTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_audio_identity,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiLibraryDbAudioIdentityDefaultConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiLibraryDbAudioIdentityDefaultConstMeta =>
      const TaskConstMeta(debugName: 'audio_identity_default', argNames: []);
  ...
  TaskConstMeta get kCrateApiInstalledFontGetInstalledFontsConstMeta =>
      const TaskConstMeta(debugName: 'get_installed_fonts', argNames: []);
  ...
  crateApiAudioOutputDeviceListRenderAudioDevices() {
    return handler.executeSync(
      SyncTask(
        ...
        codec: SseCodec(
          decodeSuccessData: sse_decode_opt_list_audio_output_device_info,
          decodeErrorData: null,
        ),
        constMeta: kCrateApiAudioOutputDeviceListRenderAudioDevicesConstMeta,
        argValues: [],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAudioOutputDeviceListRenderAudioDevicesConstMeta =>
      const TaskConstMeta(debugName: 'list_render_audio_devices', argNames: []);
  ...
  TaskConstMeta get kCrateApiNeNeLyricConstMeta =>
      const TaskConstMeta(debugName: 'ne_lyric', argNames: ['songId']);
  ...
  TaskConstMeta get kCrateApiSystemThemeSystemThemeDefaultConstMeta =>
      const TaskConstMeta(debugName: 'system_theme_default', argNames: []);
  ...
  TaskConstMeta get kCrateApiSystemVolumeSystemVolumeDisposeConstMeta =>
      const TaskConstMeta(debugName: 'system_volume_dispose', argNames: []);
  ...
  TaskConstMeta get kCrateApiSystemVolumeSystemVolumeGetConstMeta =>
      const TaskConstMeta(debugName: 'system_volume_get', argNames: []);
  ...
  TaskConstMeta get kCrateApiSystemVolumeSystemVolumeInitConstMeta =>
      const TaskConstMeta(debugName: 'system_volume_init', argNames: ['sink']);
  ...
  TaskConstMeta get kCrateApiSystemVolumeSystemVolumeSetConstMeta =>
      const TaskConstMeta(debugName: 'system_volume_set', argNames: ['val']);
  ...
  @protected
  AudioIdentity dco_decode_audio_identity(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 2)
      throw Exception('unexpected arr length: expect 2 but see ${arr.length}');
    return AudioIdentity(
      mediaId: dco_decode_opt_String(arr[0]),
      metadataKey: dco_decode_opt_String(arr[1]),
    );
  }

  @protected
  AudioOutputDeviceInfo dco_decode_audio_output_device_info(dynamic raw) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    final arr = raw as List<dynamic>;
    if (arr.length != 3)
  ...
  @protected
  List<AudioOutputDeviceInfo> dco_decode_list_audio_output_device_info(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return (raw as List<dynamic>)
        .map(dco_decode_audio_output_device_info)
        .toList();
  }
  ...
  LyricUser dco_decode_lyric_user(dynamic raw) {
    ...
    return LyricUser(nickname: dco_decode_String(arr[0]));
  }
  ...
  @protected
  List<AudioOutputDeviceInfo>? dco_decode_opt_list_audio_output_device_info(
    dynamic raw,
  ) {
    // Codec=Dco (DartCObject based), see doc to use other codecs
    return raw == null ? null : dco_decode_list_audio_output_device_info(raw);
  }
  ...
  @protected
  AudioIdentity sse_decode_audio_identity(SseDeserializer deserializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    var var_mediaId = sse_decode_opt_String(deserializer);
    var var_metadataKey = sse_decode_opt_String(deserializer);
    return AudioIdentity(mediaId: var_mediaId, metadataKey: var_metadataKey);
  }

  @protected
  AudioOutputDeviceInfo sse_decode_audio_output_device_info(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  @protected
  List<AudioOutputDeviceInfo> sse_decode_list_audio_output_device_info(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    var len_ = sse_decode_i_32(deserializer);
    var ans_ = <AudioOutputDeviceInfo>[];
    for (var idx_ = 0; idx_ < len_; ++idx_) {
      ans_.add(sse_decode_audio_output_device_info(deserializer));
    }
    return ans_;
  }
  ...
  @protected
  List<AudioOutputDeviceInfo>? sse_decode_opt_list_audio_output_device_info(
    SseDeserializer deserializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs

    if (sse_decode_bool(deserializer)) {
      return (sse_decode_list_audio_output_device_info(deserializer));
    } else {
      return null;
    }
  }
  ...
  @protected
  void sse_encode_audio_identity(AudioIdentity self, SseSerializer serializer) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_opt_String(self.mediaId, serializer);
    sse_encode_opt_String(self.metadataKey, serializer);
  }

  @protected
  void sse_encode_audio_output_device_info(
    AudioOutputDeviceInfo self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
  ...
  @protected
  void sse_encode_list_audio_output_device_info(
    List<AudioOutputDeviceInfo> self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    sse_encode_i_32(self.length, serializer);
    for (final item in self) {
      sse_encode_audio_output_device_info(item, serializer);
    }
  }
  ...
  @protected
  void sse_encode_opt_list_audio_output_device_info(
    List<AudioOutputDeviceInfo>? self,
    SseSerializer serializer,
  ) {
    // Codec=Sse (Serialization based), see doc to use other codecs
    ...
    sse_encode_bool(self != null, serializer);
    if (self != null) {
      sse_encode_list_audio_output_device_info(self, serializer);
    }
  }
...
class NetEaseCloudImpl extends RustOpaque implements NetEaseCloud {
  ...
  Future<LyricResult> getLyric({required PlatformInt64 songId}) => RustLib
      .instance
      .api
      .crateApiNeNetEaseCloudGetLyric(that: this, songId: songId);

  Future<void> init() =>
      RustLib.instance.api.crateApiNeNetEaseCloudInit(that: this);
...
class SmtcFlutterImpl extends RustOpaque implements SmtcFlutter {
  ...
  /// Apis for Flutter
  Future<void> clearDisplay() => RustLib.instance.api
      .crateApiSmtcFlutterSmtcFlutterClearDisplay(that: this);
  ...
  /// Apis for Flutter
  Future<SMTCDebugSnapshot> debugSnapshot() => RustLib.instance.api
      .crateApiSmtcFlutterSmtcFlutterDebugSnapshot(that: this);

  /// 系统在会话挂起（最小化/后台）时会静默丢弃 DisplayUpdater 更新。
  /// 通过往返切换 PlaybackStatus 强制系统端重新评估会话并重绘显示。
  /// Apis for Flutter
  Future<void> refreshDisplay() => RustLib.instance.api
      .crateApiSmtcFlutterSmtcFlutterRefreshDisplay(that: this);
